...
export function Modal({data, onCloseModal}){
    ...
    return (
        <div className="w-full h-screen bg-slate-700/80 fixed flex flex-col justify-center items-center z-50">
            <div className='w-5/6 h-5/6 border-12 bg-white dark:bg-neutral-800 shadow-md dark:shadow-blue-800 rounded-lg flex flex-col p-6 overflow-y-hidden overflow-x-hidden'>
